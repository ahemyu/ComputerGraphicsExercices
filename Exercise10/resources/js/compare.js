 ...
 */
export function errorMap(diff_map_canvas, submission_canvas_id, solution_img_id, points=1.0, error_pixel_threshold=0.05, is_shader_canvas=true, metric="l1") {
